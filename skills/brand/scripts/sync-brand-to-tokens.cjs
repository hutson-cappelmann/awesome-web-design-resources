...
// Resolve the sibling design-system skill relative to this file so it works
// both from this repo (skills/brand/scripts -> skills/design-system/scripts)
// and when skills are installed as siblings in a skills dir (.claude/skills/).
